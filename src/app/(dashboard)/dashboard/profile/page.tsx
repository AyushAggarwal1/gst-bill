          ...
          <div className="bg-white/90 backdrop-blur-sm shadow-xl rounded-2xl border border-white/20">
            <form onSubmit={handleSubmit}>
              <div className="px-6 py-6 sm:p-8">
                ...
                <div className="mb-6 p-6 bg-gray-50/50 rounded-xl border border-gray-200">
                  <div className="flex items-center space-x-4">
                    <div className="flex-shrink-0">
                    ...
                    <div className="flex-1">
                      <h4 className="text-sm font-semibold text-gray-900 mb-2">Business Logo/Photo</h4>
                      <p className="text-sm text-gray-600 mb-3">
                        Upload your company logo or business photo. This will appear on your invoices.
                      </p>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        value={profile.upiId}
                        onChange={handleChange}
                        placeholder="yourname@bank (e.g. gstly@okhdfcbank)"
                        className="pl-10 block w-full rounded-xl border-gray-200 shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 text-sm py-3 transition-all duration-200 bg-gray-50/50 hover:bg-white focus:bg-white text-gray-900"
                      />
                    </div>
                    <p className="mt-2 text-xs text-gray-500 flex items-center">
                      ...
                      Adds a scan-to-pay UPI QR code (with the exact bill amount) on your invoices
                    </p>
                  </div>
                </div>
              </div>
