  ...
  const fetchGSTDetails = async () => {
    ...
    try {
      ...
      if (data.success && data.data) {
        ...
        setCustomer((prev) => ({
          ...prev,
          name: data.data.legalName || data.data.tradeName || prev.name,
          address: data.data.principalPlaceOfBusiness?.address || prev.address,
        }));
        setGstFetched(true);
        setError("");
      } else {
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">
                Choose how you want to update customer details
              </p>
            </div>
              ...
              <div className="ml-3">
                <p className="text-sm text-gray-700">
                  {!manualEntry ? (
                    ...
                    <>
                      <span className="font-medium">Manual Entry:</span> Update all customer details manually including GST number.
                    </>
                  )}
                </p>
              </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className={`space-y-6 ${isFormDisabled ? 'opacity-50 pointer-events-none' : ''}`}>
                  <div className="flex items-center gap-3 pb-4 border-b border-gray-200">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600">
                        {isFormDisabled ? 'Enter GST number first to enable this section' : 'Update basic customer details'}
                      </p>
                    </div>
                ...
                <div className={`space-y-6 ${isFormDisabled ? 'opacity-50 pointer-events-none' : ''}`}>
                  <div className="flex items-center gap-3 pb-4 border-b border-gray-200">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600">
                        {isFormDisabled ? 'Enter GST number first to enable this section' : 'Update business and delivery locations'}
                      </p>
                    </div>
            ...
            <div className="px-6 py-6 sm:px-8 bg-gradient-to-r from-gray-50 to-gray-100 border-t border-gray-200 rounded-b-xl">
              <div className="flex flex-col sm:flex-row gap-4 sm:justify-end">
                ...
                <button
                  type="submit"
                  disabled={saving || !customer.name || !customer.address || !customer.gstNo || customer.gstNo.length !== 15 || !hasChanges()}
              ...
              {hasChanges() && (
                <div className="mt-4 pt-4 border-t border-gray-200">
                  <div className="flex items-center justify-between text-xs text-gray-500 mb-2">
                    ...
                    <span>
                      {Object.keys(customer).filter(key => 
                        customer[key as keyof typeof customer] !== originalCustomer[key as keyof typeof originalCustomer]
