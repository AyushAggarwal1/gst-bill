        ...
        <div className="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex items-center gap-2">
                  ...
                  {hasChanges() && (
                    <div className="flex items-center bg-orange-50 px-2 py-1 rounded-full">
                      ...
                      <span className="text-xs font-semibold text-orange-700">Unsaved Changes</span>
                    </div>
                  )}
                  {validation.isValid && (
                    <div className="flex items-center bg-green-50 px-2 py-1 rounded-full">
                      ...
                      <span className="text-xs font-semibold text-green-700">Valid Data</span>
                    </div>
                  )}
                </div>
          ...
          <div className="mt-3">
            <div className="flex items-center justify-between text-xs text-gray-600 mb-1">
              ...
              <span className="font-medium">{validation.completed}/{validation.total} Required Fields</span>
            </div>
      ...
      <div className="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-6 bg-gradient-to-r from-amber-50 to-orange-50 border border-amber-200 rounded-2xl p-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-semibold text-gray-900">Customer Profile Update</h3>
                <p className="text-sm text-gray-600">Modify customer details and save changes</p>
              </div>
            </div>
            <div className="flex items-center gap-2">
        ...
        <div className="bg-white/90 backdrop-blur-sm shadow-2xl rounded-2xl border border-white/20 overflow-hidden">
          <form onSubmit={handleSubmit}>
                ...
                <div className="space-y-6">
                  <div className="flex items-center gap-3 pb-3 border-b border-gray-100">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Update basic customer details</p>
                    </div>
                ...
                <div className="space-y-6">
                  <div className="flex items-center gap-3 pb-3 border-b border-gray-100">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Update business and delivery locations</p>
                    </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <textarea
                        ...
                        className="block w-full pl-12 pr-16 py-3 bg-white/90 backdrop-blur-sm border border-gray-200 rounded-xl placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 shadow-sm transition-all duration-200 resize-none"
                      />
                    </div>
                ...
                <div className="space-y-6">
                  <div className="flex items-center gap-3 pb-3 border-b border-gray-100">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Update GST registration details</p>
                    </div>
            ...
            <div className="px-6 py-4 sm:px-8 bg-gradient-to-r from-gray-50/50 to-amber-50/30 border-t border-gray-100 flex flex-col sm:flex-row sm:justify-end gap-3">
              <Link
                href="/dashboard/customers"
