              ...
              {bills.length > 0 && (
                <div className="p-4 border-b border-gray-200 flex flex-wrap items-center justify-start gap-3 print:hidden">
                  ...
                  <button
                    ...
                    className="inline-flex items-center px-3 py-1.5 border border-transparent text-xs font-medium rounded-md shadow-sm text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-indigo-500 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {creatingPDF ? (
