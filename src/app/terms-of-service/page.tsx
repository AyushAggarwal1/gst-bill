          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="mt-6 max-w-3xl mx-auto text-xl text-gray-600 leading-relaxed">
                These terms govern your use of GST Bill Maker. Please read them carefully before using our service.
              </p>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg prose-primary max-w-none">
            ...
            <div className="mb-16">
              ...
              <div className="bg-primary-50 rounded-2xl p-8 border border-primary-200/50">
            ...
            <div className="mb-16">
              ...
              <div className="bg-red-50 rounded-2xl p-8 border border-red-200/50">
                <p className="text-gray-700 mb-6">You may not use our service for:</p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-3">Illegal Activities</h3>
                    <ul className="space-y-2 text-gray-700 text-sm">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-3">Misuse</h3>
                    <ul className="space-y-2 text-gray-700 text-sm">
            ...
            <div className="mb-16">
              ...
              <div className="bg-green-50 rounded-2xl p-8 border border-green-200/50">
                <p className="text-gray-700 leading-relaxed">
        ...
        <div className="relative max-w-7xl mx-auto py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 max-w-2xl mx-auto text-xl text-primary-100 leading-relaxed">
              By using our service, you agree to these terms. Start creating professional GST invoices today.
            </p>
